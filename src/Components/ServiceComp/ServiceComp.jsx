  ...
  return (
    <div className='service'>
      ...
      <div className="exchange">
        <h1 className='text-center mt-5 text-decoration-underline text-danger fw-bold '>{props.name}</h1>
        <Banner head = {'Get Best prices For your Used Mobiles'}/>
      </div>
      <div className="Our-service">
        <h1 className='text-center fw-bold pt-4'>{props.service} <hr/></h1>
        <h3 className=' text-center text-uppercase '>Service Done For <span>All type</span> of mobiles</h3>
      </div>
      <div className="what">
          <ServiceCardComp />
      </div>
